...
view = {
		...
		mode: function(mode) {
			...
			switch (mode) {
				/*case "welcome":
					...
					$("#tools_albums, #tools_album, #tools_photo").hide();
					$("#welcome").show();
					break;*/
				case "albums":
					lychee.header.removeClass("view");
					$("#welcome, #tools_album, #tools_photo").hide();
					$("#tools_albums").show();
					break;
				case "album":
					lychee.header.removeClass("view");
					$("#welcome, #tools_albums, #tools_photo").hide();
					$("#tools_album").show();
				...
				case "photo":
					...
					$("#welcome, #tools_albums, #tools_album").hide();
					$("#tools_photo").show();
					break;
	...
	welcome: {
		...
		init: function() {
			...
			//view.welcome.title();
			view.welcome.content.init();

		},

		title: function() {

			lychee.setTitle("Bienvenue", false);
		...
		content: {
			...
			init: function() {
				lychee.content.html(build.welcomeModal);
				//lychee.content.html("<div>Test</div>");
	...
	photo: {
		...
		color: function() {
			...
			if (photo.json.init) $("#infobox .attr_color").html(photo.json.color + " " + build.editIcon("edit_color"));

		},
		
		birdsize: function() {

			if (photo.json.init) $("#infobox .attr_birdsize").html(photo.json.birdsize + " " + build.editIcon("edit_birdsize"));
