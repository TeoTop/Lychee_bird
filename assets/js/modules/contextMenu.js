...
contextMenu = {
	...
	add: function(e) {
		...
		var mouse_x = e.pageX,
			...
			items,
			file = "";
		if(lychee.fileOnServer!=="0"){
			file = "("+lychee.fileOnServer+")";
		}			
		...
		items = [
			...
			["<a class='icon-hdd'></a> Import from Server "+file, 3],
			["separator", -1],
	...
	settings: function(e) {
		...
		contextMenu.fns = [
			...
			function() { settings.setNetwork() },
			function() { settings.takePicture() },
			function() { settings.setTurnRaspberry() },
		...
		items = [
			...
			["<a class='icon-globe'></a> Search Network", 2],
			["<a class='icon-camera'></a> Take Picture", 3],
			["<a class='icon-adjust'></a> Start/Stop Raspberry", 4],
			["<a class='icon-info-sign'></a> About Lychee", 5],
			["separator", -1],
	...
	signin: function(e) {
		...
		contextMenu.fns = [
			function() { settings.setSorting() },
			function() { lychee.loginDialog() }
		];

		items = [
			["<a class='icon-sort'></a> Change Sorting", 0],
			["separator", -1],
			["<a class='icon-signout'></a> Sign In", 1]
		];
