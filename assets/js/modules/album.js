...
album = {
	...
	delete: function(albumID) {
		...
		if (albumID==="0" || albumID==="1" || albumID==="2" || albumID==="3") {
			
			buttons[0][0] = "Clear Album";
			modal.show("Clear Unsorted", "Are you sure you want to delete all photos?<br>This action can't be undone!", buttons)
