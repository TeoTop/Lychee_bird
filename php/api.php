...
if (!empty($_POST['function'])||!empty($_GET['function'])) {
	...
	if (isset($_SESSION['login'])&&$_SESSION['login']==true) {
		...
		switch ($_POST['function']) {
			...
			case 'getAlbums':		if (isset($_POST['folder']))
										echo json_encode(getAlbums(false, $_POST['folder']));
									break;
			...
			case 'setPhotoDescription':	if (isset($_POST['photoID'])&&isset($_POST['description']))
										...
										break;
			case 'setPhotoColor':	if (isset($_POST['photoID'])&&isset($_POST['color']))
											echo setPhotoColor($_POST['photoID'], $_POST['color']);
										break;
										
			case 'setPhotoBirdsize':if (isset($_POST['photoID'])&&isset($_POST['birdsize']))
											echo setPhotoBirdsize($_POST['photoID'], $_POST['birdsize']);
										break;
			...
			case 'checkServer':		echo checkServer();
									break;
			...
			case 'setNetwork':		echo setNetwork();
									break;
			...
			case 'takePicture':		if (isset($_POST['rasp']))
										echo takePicture($_POST['rasp']);
									break;
									
			case 'setFolderSorting':if (isset($_POST['sort']))
										echo setFolderSorting($_POST['sort']);
									break;
									
			// SSH
			case 'turnOpenCV':		if (isset($_POST['address'])&&isset($_POST['etat']))
										echo turnOpenCV($_POST['address'],$_POST['etat']);
									break;
									
			case 'getRasp':			echo json_encode(getRasp());
									break;
		...
		switch ($_POST['function']) {
			...
			case 'getAlbums':		if (isset($_POST['folder']))
										echo json_encode(getAlbums(true, $_POST['folder']));
									break;
